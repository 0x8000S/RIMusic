...
pub struct MusicStore {
    ...
    pub artists: HashMap<String, Vec<MusicFile>>,
    pub idx: usize,
    pub is_read: bool
}
...
impl MusicStore {
    ...
    pub fn sync_only_push(&mut self) {
    ...
    pub fn remove_tag(&mut self, player: &mut Player, tag: String) {
    ...
    pub fn remove_music_from_tag(&mut self, player: &mut Player, tag: &String, music_file: MusicFile)  {
    ...
    pub fn find_music(&self, player: &Player) -> usize {
    ...
    pub fn remove_search_origin(&mut self, p: PathBuf) {
    ...
    pub fn add_tag_for_music(&mut self, tag: String, mut music_file: MusicFile) {
    ...
    pub fn search_music_file(&self, text: &String) -> Vec<MusicFile> {
